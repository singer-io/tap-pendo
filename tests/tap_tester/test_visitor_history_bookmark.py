...
class PendoVisitorHistoryBookMarkTest(TestPendoBase):
    """Test tap sets a bookmark and respects it for the next sync of visitor and vistor_history stream"""
    
    def name(self):
        return "pendo_visitor_history_bookmark_test"
    ...
    def test_run(self):
        ...
        expected_streams = {"visitors", "visitor_history"}
